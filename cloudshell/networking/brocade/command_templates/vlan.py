...
from cloudshell.networking.brocade.command_templates.brocade_interface import CommandTemplate

VLAN_COMMANDS_TEMPLATES = {
    #'ip_address': CommandTemplate('ip address {0} {1}', [validateIP, validateIP],
                                  #['Wrong ip address!', 'Wrong ip mask!']),
    'configure_vlan': CommandTemplate('interface vlan {0}', validateVlanRange, 'Cannot create vlan - wrong vlan number(s)'),
