...
from cloudshell.networking.brocade.command_templates.brocade_interface \
    import BrocadeInterface, CommandTemplateValidator, CommandTemplate

class PortChannel(BrocadeInterface):
    COMMANDS_TEMPLATE = {
    ...
    def get_commands_list(self, **kwargs):
        prepared_commands = BrocadeInterface.get_commands_list(self, **kwargs)
